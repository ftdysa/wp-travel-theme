...
<main role="main">
    <article>
        ...
        <section class="share">
            ...
            <a
                class="icon-twitter" href="https://twitter.com/share?text=<?php esc_url(the_title()); ?>&amp;url=<?php esc_url(get_permalink()) ?>"
            ...
            <a
                class="icon-facebook" href="https://www.facebook.com/sharer/sharer.php?u=<?php esc_url(get_permalink()) ?>"
            ...
            <a
                class="icon-google-plus" href="https://plus.google.com/share?url=<?php esc_url(get_permalink()) ?>"
